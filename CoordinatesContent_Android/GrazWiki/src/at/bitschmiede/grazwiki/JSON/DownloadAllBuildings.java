...
public class DownloadAllBuildings extends AsyncTask<String, Integer, Void> {
	...
	protected Void doInBackground(String... params) {
		...
		_buildingList = null;
		try {
				_buildingList =  myRestService.getAllBuildings();
	...
	protected void onPostExecute(Void result) {
		...
		if (_listeners != null && !_listeners.isEmpty())
		{
			...
			while (e.hasMoreElements())
			{
				...
				eventHandler.downloadAllBuildingsCompleted(_buildingList);
			}
		}
	}
